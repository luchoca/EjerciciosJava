package com.example.sofka.ejerciciojava.Ejercicio4;
...
//        Los estudiantes tendrán un 50% de hacer novillos, por lo que sí hacen novillos no van a clase pero aunque no
//        vayan quedará registrado en el aula (como que cada uno tiene su sitio).
...
//        Un aula para que se pueda dar clase necesita que el profesor esté disponible, que el profesor de la materia
//        correspondiente en el aula correspondiente (un profesor de filosofía no puede dar en un aula de matemáticas)
//        y que haya más del 50% de alumnos.
//        El objetivo es crear un aula de alumnos y un profesor y determinar si puede darse clase, teniendo en cuenta
//        las condiciones antes dichas.
//        Si se puede dar clase mostrar cuántos alumnos y alumnas (por separado) están aprobados de momento (imaginad
//        que les están entregando las notas).
//
